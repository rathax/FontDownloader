  ...
  <div v-if="detailedFont !== null">
    ...
    <p class="text-base my-4">
      ...
      bundle. Learn more about the {{ detailedFont.family }} font and its License on <a class="text-primary"
        :href="'https://fonts.google.com/specimen/' + detailedFont.family + '/about'">fonts.google.com</a>.
    </p>
    ...
    <p clasS="my-2">Your generated archive for <span class="font-semibold">Akronim</span> with subsets <span
