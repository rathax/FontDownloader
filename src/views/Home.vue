...
useHead({
    ...
    meta: [
      {
        name: 'description',
        content:  `Easy way to download and self-host Google fonts with precise subset and variant selection. Download over 1500 Fonts for free with this Font Downloader.`
      },
      {
        name: 'keywords',
